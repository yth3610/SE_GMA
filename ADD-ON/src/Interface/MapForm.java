...
class MyFrame extends JFrame{
   public static final ArrayList<Position> NULL = null;
private JTextField txmap,txhazard,txstart,txfind;
   ...
   class MapComponent extends JComponent implements Finals{
      ...
      public void paint(Graphics g){
         ...
         case EAST:
            g.fillArc(20+widthmap*robotposition.getX(),355-heightmap*robotposition.getY(),50,50,robotEsa,robotEaa);
            break;
         case WEST:
            g.fillArc(20+widthmap*robotposition.getX(),355-heightmap*robotposition.getY(),50,50,robotWsa,robotWaa);
            break;
         case NORTH:
            g.fillArc(20+widthmap*robotposition.getX(),355-heightmap*robotposition.getY(),50,50,robotNsa,robotNaa);
            break;
         case SOUTH:
            g.fillArc(20+widthmap*robotposition.getX(),355-heightmap*robotposition.getY(),50,50,robotSsa,robotSaa);
            break;
         } */             
      }
   ...
   private class ButtonListener implements ActionListener{
	...
	public void actionPerformed(ActionEvent e){
         if(e.getSource()==txmap || e.getSource()==txhazard ||
        	...
        	// set 버튼을 다시 눌렀을 때 지도를 새로 그리기 위해 리스트를 초기화 하고 시작한다.
            repaint();
